...
export const CASES = [
  ...
  },
  {
    ...
    /** Expected line count — sizes the capture so the pixel diff is dense.
     *  A frame mostly full of blank space dilutes the ratio and hides real
     *  differences below the 0.1%% threshold. */
    lines: 1,
    width: 600,
  },
  {
