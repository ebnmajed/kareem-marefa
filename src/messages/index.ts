...
export const NAMESPACES = ["marketing", "ui", "auth", "app", "profile", "proposals", "event", "ratings", "rsvp", "checkin", "admin", "sessions", "notifications", "scoring", "calendar", "leaderboards", "recognition", "materials", "photos", "tasks", "search", "browse", "designer", "templates", "certificates", "branding", "platform", "legal", "privacy", "members"] as const;
