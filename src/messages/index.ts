...
export const NAMESPACES = ["marketing", "ui", "auth", "app", "profile", "proposals", "event", "ratings", "rsvp", "checkin", "admin", "sessions", "notifications", "scoring", "calendar", "leaderboards"] as const;
