...
// One row of SCR-050's queue. Same "reason behind a <details>" shape
// `admin/proposals/review-card.tsx` uses: removal needs its reason on
// screen before the button that needs it can be pressed.
    ...
    <li className="rounded-field border border-edge p-5">
      ...
      <form action={formAction} className="mt-5 border-t border-edge pt-5">
        <div className="flex flex-wrap items-center gap-3">
          <Button type="submit" name="action" value="dismiss" variant="secondary" disabled={pending}>
            {t("dismiss")}
          </Button>
