...
//
// ★ Built by `sessions` for the event page (wave 6) and moved into the shell by
// the lead: the sticky header covers a focused breadcrumb on EVERY long page,
// not just the event page, so it is mounted once in `app/layout.tsx`.
